    ...
    <section className="content limited-large">
      ...
      >
        <div className="random-entry overflow-auto">
          <p>In the meantime, this is how you write a Hello World for Java:</p>
          <pre
...
fun main(args : Array&lt;String&gt;) {
  println("Hello, world!")
        ...
        <div className="random-entry overflow-auto hide">
          <p>In the meantime, this is how you write a Hello World for Scala:</p>
          <pre
            dangerouslySetInnerHTML={{
...
int main (int argc, const char * argv[]) {
  ...
  return 0;
        ...
        <div className="random-entry overflow-auto hide">
          <p>In the meantime, this is how you write a Hello World for .Net:</p>
          <pre
            dangerouslySetInnerHTML={{
...
message:
    db  'Hello, World', 10, 0`,
        ...
        <div className="random-entry overflow-auto hide">
          <p>In the meantime, this is how you write a Hello World for Bash:</p>
          <pre
            dangerouslySetInnerHTML={{
              __html: `#!/bin/bash
STR="Hello World!"
...
main = putStrLn "Hello, World!"`,
        ...
        <div className="random-entry overflow-auto hide">
          <p>In the meantime, this is how you write a Hello World for Rust:</p>
          <pre
            dangerouslySetInnerHTML={{
              __html: `fn main() {
  println!("Hello, world!");
